...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    #t_5_1.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 5.1  Herramientas y medidas de control
    ...
    .row.justify-content-center.mb-5
      .col-lg-8(data-aos="fade-right")
        TabsA.color-secundario.mb-5
          ...
          .tarjeta.p-4(titulo="Planes de seguridad" style='background-color: #e5e7f2')
          ...
          .tarjeta.p-4(titulo="Destrucción de información" style='background-color: #e5e7f2')
        ...
        .bloque-derecha
          .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5
            ...
            .bloque-texto-g__texto.p-4
              p.mb-0 Es indispensable la pedagogía en este aspecto, la cual debe estar enfocada hacía prevenir la generación de residuos, tomando conciencia de la utilización de los aparatos y de la disposición que se les da a estos, cuando ya no se utilizan, dado que se convierten en posibles factores de contaminación y pueden resultar peligrosos.
    p.mb-5(data-aos='fade-right') Se recomienda seguir algunas medidas (Ministerio de Ambiente y Desarrollo Sostenible 2021) que eviten este tipo de acciones, entre ellas pueden estar:
    .row.justify-content-center.mb-5
      .col-lg-4.mb-lg-0.mb-3
        .tarjeta(style="background-color: #e0f0fc ").p-4.h-100
          ...
          p.text-center Realizar la divulgación de las normas acerca del manejo de los RAEE generando conciencia y empatía hacía la necesidad de aplicarlas en el entorno.
      .col-lg-4.mb-lg-0.mb-3
        .tarjeta(style="background-color: #e0f0fc ").p-4.h-100
    ...
    #t_5_4.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 5.4  Manejo de sustancias peligrosas
    p.mb-5(data-aos='fade-right') Este es un tema importante en los RAEE, cabe aclarar que son un porcentaje pequeño los componentes que pueden ocasionar el peligro, pero debe tratarse con mucha cautela y responsabilidad.
      br
      br
